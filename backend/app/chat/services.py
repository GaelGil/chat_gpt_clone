...
class ChatService:
    ...
    async def init_utils(self):
        """Initialize utilities for the agent"""
        if self.mcp_client and self.tools and self.llm and self.planner:
            return True
    ...
    async def process_message(self, user_message):
        ...
        """
        utils_initialized = await self.init_utils()
        if not utils_initialized:
            return {"success": False, "error": "Failed to initialize utils"}
        ...
        try:
            ...
            print("\n--- Making initial API call to model ---")
            ...
            plan_parsed = plan.output_parsed  # parse plan
