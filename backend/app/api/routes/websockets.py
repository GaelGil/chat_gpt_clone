...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, message_id: uuid.UUID):
    ...
    def disconnect(self, websocket: WebSocket, message_id: uuid.UUID):
    ...
    async def send_to_canvas(self, message_id: uuid.UUID, message: dict):
    ...
    async def stream_response_chunk(
        self, message_id: uuid.UUID, chunk: str, is_complete: bool = False
    ):
...
async def message_websocket(websocket: WebSocket, message_id: uuid.UUID):
