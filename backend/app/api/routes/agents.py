...
# Routes
@agents.route("/agents/status", methods=["GET"])
...
@agents.route("/agents/query", methods=["POST"])
def query_agent():
...
@agents.route("/agents/query/stream", methods=["POST"])
...
@agents.route("/agents/code-search", methods=["POST"])
...
@agents.route("/agents/code-search/summary/<context_id>", methods=["GET"])
def get_code_search_summary(context_id: str):
    try:
        ...
        return jsonify({"detail": f"Failed to get code search summary: {str(e)}"}), 500


@agents.route("/agents/context/<context_id>", methods=["DELETE"])
...
@agents.route("/agents/semantic-search", methods=["POST"])
def perform_semantic_search():
    ...
    try:
        ...
        return jsonify({"detail": f"Failed to perform semantic search: {str(e)}"}), 500


@agents.route("/agents/code-analysis", methods=["POST"])
def perform_code_analysis():
    ...
    try:
        ...
        return jsonify({"detail": f"Failed to perform code analysis: {str(e)}"}), 500


@agents.route("/agents/documentation", methods=["POST"])
def generate_documentation():
    ...
    try:
        ...
        return jsonify({"detail": f"Failed to generate documentation: {str(e)}"}), 500
