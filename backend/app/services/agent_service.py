...
from ai.src.a2a_mcp.agents.OrchestratorAgent import OrchestratorAgent
from ai.src.a2a_mcp.agents.EssayAgent import EssayAgent
...
class AgentService:
    ...
    def __init__(self):
        ...
        self.code_search_agents: Dict[str, EssayAgent] = {}
    ...
    async def get_code_search_agent(self, agent_type: str) -> EssayAgent:
        ...
        if agent_type not in self.code_search_agents:
            ...
            self.code_search_agents[agent_type] = EssayAgent(
    ...
    async def query_agent(
        self, agent_type: str, query: str, context_id: str, task_id: str
    ...
    async def clear_agent_context(self, context_id: str) -> Dict[str, str]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Failed to clear context: {str(e)}"}
    ...
    async def generate_code_search_summary(self, context_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"context_id": context_id, "summary": summary, "status": "completed"}
        except Exception as e:
